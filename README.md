...
See `docs/SPEC.md`, `docs/DSP.md`, `docs/VALIDATION.md`, `docs/GATE_A.md`, `docs/REALIMPACT.md`, `docs/GATE_B.md`, `docs/GATE_C.md`, `docs/VALIDATION_EVIDENCE.md`, `docs/EMPIRICAL_CAMPAIGN.md`, `docs/ACOUSTIC_DNA.md`, `docs/ACOUSTIC_CARD.md`, `docs/RINGDOWN_LENS.md`, `docs/ACOUSTIC_STORY.md`, `docs/SAVED_CAPTURES.md`, `docs/CAPTURE_COMPARISON.md`, and `docs/DEPLOYMENT.md` for the implementation contracts, release gates, evidence model, campaign-integrity contract, visual artifacts, saved-capture and comparison boundaries, and deployment path.
